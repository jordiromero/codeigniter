...
<body>
	...
	<div class="container">
        <div class="navbar-header">
          ...
          <a href="<?php echo base_url();?>" class="navbar-brand">Menu Principal</a>
        </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="<?php echo base_url();?>index.php/users/createUser">Registrat</a></li>
            <li><a href="<?php echo base_url();?>index.php/users/editUser">Canvia contrasenya</a></li>
            <li><a href="<?php echo base_url();?>index.php/users/editUser">Modifica l'usuari</a></li>
          </ul>
        </div>
      </div>
      </div>
